...
movieRouter.get("/", protect_1.protect, movieController_1.getMovies);
movieRouter.get("/:id", protect_1.protect, movieController_1.getMovieById);
movieRouter.post("/", protect_1.protect, movieController_1.createMovie);
movieRouter.put("/:movieId", protect_1.protect, movieController_1.updateMovie);
movieRouter.delete("/:movieId", protect_1.protect, movieController_1.deleteMovie);
/**
 * @swagger
 * tags:
 *   - name: Movies
